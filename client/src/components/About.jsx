  ...
  return (
    <section id="about" className="bg-white py-20 px-4 md:px-10">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-extrabold text-phoenixPink mb-6">About Us</h2>
        <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
          At <span className="font-bold text-phoenixPink">Phoenix Fitness Centre</span>, we believe in transformation. 
